...
{
    [TestFixture]
    public class GetAllInterfaceProperties
    {
        public interface SubSubA
        {
            DateTime Created { get; set; }
        }

        public interface SubA : SubSubA
        {
            string Foo { get; set; }
        }
        ...
        public interface Main : SubA, SubB
        {
            bool Flag { get; set; }
        }
        ...
        public void ShouldReturnAllPropertiesFromAllInterfaces()
        {
            ...
            var sut = typeof(Main);
            // Act
            var result = sut.GetAllInterfaceProperties();
            // Assert
            Expect(result)
            ...
            Expect(result)
                ...
                .Matched.By(o =>
                    o.Name == "Bar" &&
                    o.PropertyType == typeof(int)
                );
            Expect(result)
                .To.Contain.Exactly(1)
                .Matched.By(o =>
                    o.Name == "Flag" &&
                    o.PropertyType == typeof(bool)
                );
        }

        [Test]
        public void ShouldIncludeAllImplementationsOnRequest()
        {
            // Arrange
            var sut = typeof(Main);

            // Act
            var result = sut.GetAllInterfaceProperties(true);
            // Assert
            Expect(result)
                .To.Contain.Exactly(2)
                .Matched.By(o =>
                    o.Name == nameof(Main.Flag) &&
                    o.PropertyType == typeof(bool)
                );
        }
    }
    ...
    public class HasAttribute
    {
        ...
        public class OperatingOnType
        {
            ...
            public void ShouldFindAttributeWithMatcher()
            {
                ...
                // Act
                Expect(
                        sut.HasAttribute<ClassAttribute>(o => o.Name == "Test Class"
                        )
                    )
                    .To.Be.True();
                // Assert
        ...
        public class OperatingOnMethodInfo
        {
            ...
            public void ShouldFindBaseMethodAttributeWithMatcher()
            {
                ...
                Expect(
                    sut.HasAttribute<BaseMethodAttribute>(a => a.Id == 123
                    )
                ).To.Be.True();
                Expect(sut.HasAttribute<BaseMethodAttribute>(false))
                    .To.Be.False();
        ...
        public class OperatingOnMethodParameter
        {
            ...
            public void ShouldBeAbleToMatchByAttributeProps()
            {
                ...
                // Act
                Expect(
                    first.HasAttribute<ParameterAttribute>(a => a.Name == "foo"
                    )
                ).To.Be.True();
                Expect(
                    first.HasAttribute<ParameterAttribute>(a => a.Name == "bar"
                    )
                ).To.Be.False();
                // Assert
            }
        ...
        public void ShouldPresentGroupsOfAttributesPerType()
        {
            ...
            foreach (var item in typeof(B).WalkAttributes())
            {
                ...
                if (idx == 0)
                {
                    ...
                    Expect(item.Attributes)
                        .To.Contain.Exactly(1)
                        .Matched.By(o => o is DescriptionAttribute d &&
